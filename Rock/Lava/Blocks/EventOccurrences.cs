...
namespace Rock.Lava.Blocks
{
    ...
    public class EventOccurrences : RockLavaBlockBase
    {
        ...
        /// </summary>
        public static string TagSourceName = "eventoccurrences";
        public static string ParameterEventId = "eventid";
        ...
        private void RenderInternal( Context context, TextWriter result )
        {
            ...
            //var unknownNames = _settings.GetUnknownAttributes( new List<string> { ParameterEventId, ParameterDateRange, ParameterMaxOccurrences, ParameterStartDate } );
            ...
            //var calendar = ResolveCalendarSettingOrThrow( rockContext, _settings.GetStringValue( ParameterEventId ) );
            ...
            //var events = GetCalendarEventOccurrences( calendar.Id, maxOccurrences, startDate, endDate );
        ...
        //private List<EventOccurrenceSummary> GetCalendarEventOccurrences( int calendarId, int maxOccurrences, DateTime? startDate, DateTime? endDate )
        //{
        //    var rockContext = new RockContext();
